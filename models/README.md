...
|---|---:|---|---|
| SmolLM2-135M INT8 | 136 MB | `models/smollm2-135m-int8/carrier-huffman16.json` | Lightest acceptable neural trial |
| SmolLM2-360M INT8 | 363 MB | `models/smollm2-360m-int8/carrier-huffman16.json` | Best tested quality/density balance |
| Qwen3-0.6B INT8 | 618 MB | `models/qwen3-0.6b-int8/carrier-huffman32.json` | Rejected in this carrier experiment |
